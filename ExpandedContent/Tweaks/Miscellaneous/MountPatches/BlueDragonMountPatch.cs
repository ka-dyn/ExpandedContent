...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchBlueDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "a120453e1cccf844e961d53f2ffff58d")  //BlueDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Blue Drake Mount Patch");
                PatchBlueDragonAsset(view);
                Main.Log("Finished Blue Drake Mount Patch");
            }
        }
        public static void PatchBlueDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumBlueDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeBlueDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeBlueDragon_MountConfig";
