...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchRedDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "67357674949597e42a6218617a2a6e34")  //RedDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Red Drake Mount Patch");
                PatchRedDragonAsset(view);
                Main.Log("Finished Red Drake Mount Patch");
            }
        }
        public static void PatchRedDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumRedDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeRedDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeRedDragon_MountConfig";
