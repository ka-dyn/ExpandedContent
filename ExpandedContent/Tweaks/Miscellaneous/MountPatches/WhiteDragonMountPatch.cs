...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchWhiteDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "bc5a9831baef093408de52fa944e8659")  //WhiteDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting White Drake Mount Patch");
                PatchWhiteDragonAsset(view);
                Main.Log("Finished White Drake Mount Patch");
            }
        }
        public static void PatchWhiteDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumWhiteDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeWhiteDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeWhiteDragon_MountConfig";
