...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchCopperDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "4e5f20a3eede2844789bf9e260192130")  //CopperDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Copper Drake Mount Patch");
                PatchCopperDragonAsset(view);
                Main.Log("Finished Copper Drake Mount Patch");
            }
        }
        public static void PatchCopperDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumCopperDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeCopperDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeCopperDragon_MountConfig";
