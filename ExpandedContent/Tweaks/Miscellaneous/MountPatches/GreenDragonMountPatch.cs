...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchGreenDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "e14f1d86baa5b2a438dde844487e0491")  //GreenDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Green Drake Mount Patch");
                PatchGreenDragonAsset(view);
                Main.Log("Finished Green Drake Mount Patch");
            }
        }
        public static void PatchGreenDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumGreenDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeGreenDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeGreenDragon_MountConfig";
