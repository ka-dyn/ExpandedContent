...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchSilverDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "9bb39e432192f1e46a8ff5798ba82dc0")  //SilverDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Silver Drake Mount Patch");
                PatchSilverDragonAsset(view);
                Main.Log("Finished Silver Drake Mount Patch");
            }
        }
        public static void PatchSilverDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumSilverDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeSilverDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeSilverDragon_MountConfig";
