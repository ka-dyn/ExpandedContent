...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchBlackDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "1d5a2ef7c2529be49879b1399b55a34a")  //BlackDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Black Drake Mount Patch");
                PatchBlackDragonAsset(view);
                Main.Log("Finished Black Drake Mount Patch");
            }
        }
        public static void PatchBlackDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumBlackDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeBlackDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeBlackDragon_MountConfig";
