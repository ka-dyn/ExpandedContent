...
namespace ExpandedContent.Tweaks.Miscellaneous.MountPatches {
    ...
    public static class PatchBronzeDragonOnLoad {

        [HarmonyPrefix]
        public static void Prefix(object resource, string guid) {
            if (guid != "f404012956ec5904b886f495514cb4dc")  //BronzeDragon
                return;
            if (resource is UnitEntityView view) {
                Main.Log("Starting Bronze Drake Mount Patch");
                PatchBronzeDragonAsset(view);
                Main.Log("Finished Bronze Drake Mount Patch");
            }
        }
        public static void PatchBronzeDragonAsset(UnitEntityView view) {
            ...
            MediumOffsetConfig.name = "MediumBronzeDragon_MountConfig";
            ...
            LargeOffsetConfig.name = "LargeBronzeDragon_MountConfig";
            ...
            HugeOffsetConfig.name = "HugeBronzeDragon_MountConfig";
