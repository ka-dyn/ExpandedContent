...
namespace ExpandedContent.Tweaks.Curses {
    internal class Vampirism {
        ...
        public static void AddVampirismCurse() {
            ...
            DualCursedSecondCurseSelection.m_AllFeatures = DualCursedSecondCurseSelection.m_AllFeatures.AppendToArray(VampirismCurseNoProgression.ToReference<BlueprintFeatureReference>());
            DualCursedSecondCurseSelection.m_Features = DualCursedSecondCurseSelection.m_Features.AppendToArray(VampirismCurseNoProgression.ToReference<BlueprintFeatureReference>());
