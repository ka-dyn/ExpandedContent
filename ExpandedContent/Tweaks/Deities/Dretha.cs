...
namespace ExpandedContent.Tweaks.Deities {
    internal class Dretha {
        ...
        public static void AddDrethaFeature() {
            ...
            var DrethaIcon = AssetLoader.LoadInternal("Deities", "Icon_Dretha.jpg");
            var DrethaFeature = Helpers.CreateBlueprint<BlueprintFeature>("DrethaFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Dark Mother   " +
                    ...
                    "\nSubdomains: Defense, Demon, Family, Home   " +
                    "\nFavoured Weapon: Scimitar   " +
                    "\nHoly Symbol: Two gauntleted fists   " +
                    "\nSacred Animal: Dire wolf   " +
                    "\nDretha reigns over all aspects of orc domestic life. The Dark Mother is not a goddess of love, but of possessiveness. As the goddess of fertility, she " +
                    "watches over female orcs during pregnancy, birthing, and child rearing. She promotes mating, families, and tribes, not because she is a nurturing deity, " +
                    "but because she believes in strength in numbers and fostering strong warriors. Dretha is the patron of crafts, yet all orc gods are war gods, and Dretha " +
                    "is no different. The Dark Mother blesses those who fight jealously to defend their mates, children, lands, and possessions from enemies who would steal or " +
                    "destroy them. Dretha is depicted as a heavily pregnant orc. Sculptures of the Dark Mother emphasize her swollen belly and breasts, while leaving her head " +
                    "and limbs small and lacking in detail. Legends describe Dretha as a sullen goddess who rarely speaks. Yet the stories told by true devotees say her melancholy " +
                    "is a cage that holds a burning rage within. Orcs typically claim Dretha is the mate of the male god their tribe holds in highest esteem. Dretha is the most " +
                    "widely revered of the orc gods, and while tribes may come to blows over which orc god is superior, all acknowledge the Dark Mother. Dretha is primarily " +
                    "worshiped by female orcs, who sacrifice to her to ensure safe childbirth and strong children. But all orcs, regardless of their gender, seek the Dark Mother’s " +
                    "aid in matters of defense or procreation. Tales tell of Dretha’s ancient conflict with Lamashtu, and rarely do her followers also venerate the demonic " +
                    "Mother of Monsters.");
                bp.m_Icon = DrethaIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Dretha", DrethaFeature, WeaponCategory.Scimitar);
