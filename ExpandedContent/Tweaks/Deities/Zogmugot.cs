...
namespace ExpandedContent.Tweaks.Deities {
    internal class Zogmugot {
        ...
        public static void AddZogmugotFeature() {
            ...
            var ZogmugotIcon = AssetLoader.LoadInternal("Deities", "Icon_Zogmugot.jpg");
            var ZogmugotFeature = Helpers.CreateBlueprint<BlueprintFeature>("ZogmugotFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Lady Lastbreath   " +
                    ...
                    "\nHoly Symbol: Seaweed draped chest  " +
                    "\nSacred Animal: Crab   " +
                    "\nThe most clever and observant of the four goblin hero-gods, but also the easiest to distract, Zogmugot encourages her followers to make the most " +
                    "out of their surroundings. Any goblin who discovers a way to make broken or discarded objects useful (or, even better, deadly) earns her favor. She " +
                    "rewards those who need her the least, showering luck and inspiration on goblins who find their own solutions to problems. Though she answers prayers " +
                    "as often as any of the four, her blessings frequently fade once her attention wanes. Goblins wishing to do her honor typically swim out of sight of " +
                    "land, hold their breath underwater until they nearly fall unconscious, or do something similar that risks drowning. As the closest thing goblins " +
                    "have to a patron of invention, craft, and creativity, most tribes have at least one member who pays her homage by creating weapons or clever deathtraps.");
                bp.m_Icon = ZogmugotIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Zogmugot", ZogmugotFeature, WeaponCategory.Sickle);
