...
namespace ExpandedContent.Tweaks.Deities {
    internal class Hadregash {
        ...
        public static void AddHadregashFeature() {
            ...
            var HadregashFeature = Helpers.CreateBlueprint<BlueprintFeature>("HadregashFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Greatest Supreme Chieftain Boss" +
                    ...
                    "\nHoly Symbol: Chain and manacle  " +
                    "\nSacred Animal: Cougar   " +
                    "\nThe First Songs tell of a time when Golarion was still young and Lamashtu gave birth to four vile, wolflike creatures called barghests " +
                    "to hunt and feast on the flesh of the world’s primitive people. These beasts devoured thousands of unfortunate victims, and whenever a " +
                    "barghest spilled hot blood upon the ground, the pools quickly grew into monsters that were similar in temperament, if not appearance: " +
                    "the first goblins. The barghests took their so-called children with them and spread across the world, conquering areas where they continue " +
                    "to menace mortalkind. With each soul a barghest consumed, it grew in strength, until it evolved into a greater, more powerful version of itself, " +
                    "a true paragon of its race. Among these greater barghests arose four who attained divinity in this way—the barghest hero-gods—subservient " +
                    "only to Lamashtu herself. And the mightiest among these barghest hero-gods was Hadregash.");
                bp.m_Icon = HadregashIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Hadregash", HadregashFeature, WeaponCategory.Flail);
