...
namespace ExpandedContent.Tweaks.Deities {
    internal class Sivanah {
        ...
        public static void AddSivanahFeature() {
            ...
            var SivanahIcon = AssetLoader.LoadInternal("Deities", "Icon_Sivanah.jpg");
            var SivanahFeature = Helpers.CreateBlueprint<BlueprintFeature>("SivanahFeature", (bp => {
                bp.SetName("Sivanah");
                bp.SetDescription("\nTitles: The Seventh Veil, Goddess of Illusions   " +
                    "\nAlignment: Neutral   " +
                    "\nAreas of Concern: Illusions, Reflections, Mysteries, Veils   " +
                    "\nEdict: Show the beauty in illusions, pursue the nature of truth, respect the need for secrets   " +
                    ...
                    "the surface of water, and is said to speak to some of her followers through their own shadows. Her ultimate goals are secrets even to her most faithful, a level " +
                    "of secrecy that prevents her devout from growing much more beyond the level of a cult. Illusionists, tricksters, and those who work to preserve secrets and " +
                    "mystery often worship Sivanah, as do many gnomes, in keeping with their love of illusion magic and strange experiences. Priests of Sivanah tend to dress in veils " +
                    "and multiple layers of thin clothing that obscure their features and often go out of their way to give outsiders false impressions of their race, gender, and more " +
                    "general features. The church is tight-lipped about its practices, leading outsiders to suspect they have nefarious motives, but such concerns are somewhat " +
                    "mitigated by their festive and welcoming public holidays. Magic mirrors, veils, and magical cloths are popular tools among the priesthood. Rumors " +
                    "abound that some of the most powerful priests in the church are actually monstrous creatures, matching the goddess's affinity for such beings.");
                bp.m_Icon = SivanahIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Sivanah", SivanahFeature, WeaponCategory.Glaive);
