...
namespace ExpandedContent.Tweaks.Deities {
    internal class QiZhong {
        ...
        public static void AddQiZhongFeature() {
            ...
            var QiZhongFeature = Helpers.CreateBlueprint<BlueprintFeature>("QiZhongFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Master of Medicine   " +
                    ...
                    "\nSacred Animal: Crane   " +
                    "\nQi Zhong is the Master of Medicine, god of healing and magic. It was Qi Zhong, at Shizuru’s bequest, who employed his skill " +
                    "and magic to bring the moon god Tsukiyo back to life after he was slain by his brother Fumeiyoshi, and it was Qi Zhong who first " +
                    "taught mortals the importance of the five elements—fire, earth, metal, water, and wood—and their connection to magic, medicine, and " +
                    "martial arts, among other pursuits. Healers, sages, scholars, and practitioners of traditional Tian medicine venerate Qi Zhong, as do " +
                    "wizards and mystic theurges, many of whom serve in his priesthood. Qi Zhong’s faithful believe it is their duty to teach their knowledge " +
                    "and learning to others. He appears as a kindly older man dressed in a healer’s robe that seems to shift between the five elements.");
                bp.m_Icon = QiZhongIcon;
                bp.Ranks = 1;
