...
namespace ExpandedContent.Tweaks.Deities {
    internal class Seramaydiel {
        ...
        public static void AddSeramaydielFeature() {
            ...
            var SeramaydielFeature = Helpers.CreateBlueprint<BlueprintFeature>("SeramaydielFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Lady of Inspired Notes   " +
                    ...
                    "\nSeramaydiel loves instrumental music but favors the harp above all. When astradaemons first emerged from the Abyss and began snatching " +
                    "wandering spirits from the River of Souls on the Astral Plane, it is said that Seramaydiel was able to call the lost souls belonging to " +
                    "Nirvana back to her with her majestic harping. Seramaydiel's burnished red-gold hair falls in broad curls around her face and frames the " +
                    "white wings that rise from her slender back. She uses her heavenly double chromatic harp to lull evildoers into a false sense of security, " +
                    "then slays them, if she must, using holy darts projected from a narrow bronze tube she uses as a blowgun. The Lady of Inspired Notes speaks " +
                    "all languages and enjoys fostering communication between disparate parties, especially when doing so may avert potential violence. A diplomat " +
                    "negotiating peace between countries and a tavern patron trying to head off a bar fight are both regarded by Seramaydiel as emissaries ofher " +
                    "cause. Seramaydiel's home is a vast marble amphitheater on Nirvana where the empyreal lords sometimes congregate for music and dancing as " +
                    "Seramaydiel plays a tune from her enchanted harp, much to the delight of all in attendance.");
                bp.m_Icon = SeramaydielIcon;
                bp.Ranks = 1;
