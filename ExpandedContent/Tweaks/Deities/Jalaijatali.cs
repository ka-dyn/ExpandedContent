...
namespace ExpandedContent.Tweaks.Deities {
    internal class Jalaijatali {
        ...
        public static void AddJalaijataliFeature() {
            ...
            var JalaijataliFeature = Helpers.CreateBlueprint<BlueprintFeature>("JalaijataliFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Rillsong   " +
                    ...
                    "drakes or water oni. On Elysium, Jalaijatali lives in a pool fed by a waterfall that falls continually from the sky with no apparent source. " +
                    "Around the pool stands a gazebo of acacia wood and crystal, with raised wooden platforms covered in soft mats of greenery where guests can " +
                    "recline.");
                bp.m_Icon = JalaijataliIcon;
                bp.Ranks = 1;
