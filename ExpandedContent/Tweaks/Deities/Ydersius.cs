...
namespace ExpandedContent.Tweaks.Deities {
    internal class Ydersius {
        ...
        public static void AddYdersiusFeature() {
            ...
            var YdersiusFeature = Helpers.CreateBlueprint<BlueprintFeature>("YdersiusFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Headless King, Lord of Coiling Poison, the Father of Serpents   " +
                    ...
                    "\nHoly Symbol: Snake skull and ouroboros   " +
                    "\nSacred Animal: Snake   " +
                    "\nThis ancient being was the patron god of the all-but-forgotten race of snake-men that battled mighty Azlant and lost. Forced to hide in " +
                    "the Darklands with his mortal servants, the Serpent King was decapitated by a mighty champion, but such was the power of the god that he " +
                    "remained alive in two pieces. Now his mindless body thrashes recklessly, and his head is lost and presumably rotted away to a skull; but " +
                    "there are some that say the skull still thinks and can control a tiny measure of power, and if it and the body were ever reunited, Ydersius " +
                    "would heal and lead his people in an attack on the surface world.");
                bp.m_Icon = YdersiusIcon;
                bp.Ranks = 1;
