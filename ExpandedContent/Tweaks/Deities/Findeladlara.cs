...
namespace ExpandedContent.Tweaks.Deities {
    internal class Findeladlara {
        ...
        public static void AddFindeladlaraFeature() {
            ...
            var FindeladlaraIcon = AssetLoader.LoadInternal("Deities", "Icon_Findeladlara.jpg");
            var FindeladlaraFeature = Helpers.CreateBlueprint<BlueprintFeature>("FindeladlaraFeature", (bp => {
                bp.SetName("Findeladlara");
                bp.SetDescription("\nTitles: The Guiding Hand   " +
                    ...
                    "\nSacred Animal: Stag   " +
                    "\nThough she represents art and architecture, she is more a deity of preserving existing traditions than inspiring innovation. " +
                    "Well-meaning but aloof, she disdains the work of the younger races and never answers the prayers of non-elves. She is always shown " +
                    "dressed in beautiful classically styled or archaic clothing, framed in an elaborate archway of mithral or living branches, and " +
                    "illuminated in the ruddy glow of a sun just below the horizon. Her symbol is a hand pointing upward suspending a golden star or flame." +
                    "\nAppearance: When shown in art, she appears as a beautiful elven woman in traditional elven dress. She is normally depicted standing " +
                    "beneath an archway of either mithral or branches, whilst being illuminated by the setting sun. ");
                bp.m_Icon = FindeladlaraIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Findeladlara", FindeladlaraFeature, WeaponCategory.Quarterstaff);
