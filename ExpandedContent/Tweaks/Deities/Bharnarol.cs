...
namespace ExpandedContent.Tweaks.Deities {
    internal class Bharnarol {
        ...
        public static void AddBharnarolFeature() {
            ...
            var BharnarolFeature = Helpers.CreateBlueprint<BlueprintFeature>("BharnarolFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Tempered Inventor   " +
                    ...
                    "\nThe Tempered Inventor prefers spending time in his workshop, but occasionally he visits a gifted crafter in person, " +
                    "usually if the crafter is at risk of releasing a dangerous invention into the world. Bharnarol prefers guiding artists through " +
                    "discourse, but may resort to force if necessary. No matter how foul the object or how evil its creator's intent, though, Bharnarol " +
                    "cannot bring himself to destroy any invention. Instead, he steals such inventions away and locks them up in the Unflawed Vault " +
                    "below his workshop. The Tempered Inventor's workshop itself stands among the foothills of the Dragonmane Mountains in Nirvana. A grand " +
                    "tunnel leads from the workshop to the Caverns of Molten Sunlight beneath the mountains, where Bharnarol can work his metallurgic wonders " +
                    "in the living golden heat of his blessed forge.   " +
                    "\nAppearance: Bharnarol is a powerful figure with muscular arms for stoking forges and hammering metal. His head is that of an elephant, " +
                    "with silver skin, wise eyes, and ivory tusks. He wears a neat leather apron embossed with images of industry and invention: anvils, books, " +
                    "flasks, forges, honeycombs, kilns, pulleys, and water wheels.");
                bp.m_Icon = BharnarolIcon;
                bp.Ranks = 1;
