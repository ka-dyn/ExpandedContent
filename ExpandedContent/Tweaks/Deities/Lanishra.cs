        ...
        public static void AddLanishraFeature() {
            ...
            var LanishraFeature = Helpers.CreateBlueprint<BlueprintFeature>("LanishraFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Slavelord   " +
                    ...
                    "\nSubdomains: Demon, Resolve, Slavery, Tyranny   " +
                    "\nFavoured Weapon: Heavy flail   " +
                    "\nHoly Symbol: Sabre-tooth tiger skull   " +
                    "\nSacred Animal: Sabre-toothed tiger   " +
                    "\nLanishra is the orc god of rulership. He assures orcs of their inherent superiority over all other humanoids, and over most other creatures as well. The Slavelord " +
                    "does not believe in peers, teaching that in all relationships one party is superior to the other. An orc must know his place in the pecking order, but he must never " +
                    "be satisfied unless he’s at the top. For a follower of Lanishra, it’s better to be feared than loved, for only those who can dominate others deserve to lead. Lanishra " +
                    "is depicted as an orc chieftain, richly attired (for an orc), but armed for a fight. His favored weapon is the war flail—a mockery of the farmer’s tool, unsuitable " +
                    "for threshing grain but ideal for flaying those who disobey him or deign to think themselves his better. Lanishra teaches that a warrior’s job is to excel at warfare " +
                    "and that manual labor is beneath him. The reward for a warrior’s work is the free acquisition of the goods produced by those he conquers—both from their past labors " +
                    "and those carried out under his whip. Lanishra’s philosophy is most at odds with those of Nulgreth and Zagresh, who would rather kill than enslave. Yet his fiercest " +
                    "rival is Verex, whose desire for slaves equals the Slavelord’s; despite their shared goal, the two rarely get along. Tribes dedicated to Lanishra are heavily involved " +
                    "in the slave trade, though even tribes devoted to other gods may have priests of the Slavelord to oversee their chattel. Many orc chieftains promote the worship of " +
                    "Lanishra, as his teachings legitimize their rule and supremacy.");
                bp.m_Icon = LanishraIcon;
                bp.Ranks = 1;
