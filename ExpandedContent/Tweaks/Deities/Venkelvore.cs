...
namespace ExpandedContent.Tweaks.Deities {
    internal class Venkelvore {
        ...
        public static void AddVenkelvoreFeature() {
            ...
            var VenkelvoreIcon = AssetLoader.LoadInternal("Deities", "Icon_Venkelvore.jpg");
            var VenkelvoreFeature = Helpers.CreateBlueprint<BlueprintFeature>("VenkelvoreFeature", (bp => {
                bp.SetName("Venkelvore");
                bp.SetDescription("\nTitles: Most Glorious Neverfull " +
                    ...
                    "\nHoly Symbol: Half-eaten piece of food " +
                    "\nSacred Animal: Crow   " +
                    "\nReckoned the most beautiful of the four barghest deities, this immense and grotesquely obese deity suffers from an insatiable hunger. " +
                    "Goblins credit her for their ability to eat just about anything. Her most ardent worshipers claim that goblins can also feed on pain itself and " +
                    "encourage them to regard torture as a sort of meal. Goblins seeking to honor her must make gifts of food.By custom, deceased priests of Venkelvore " +
                    "are often cut open and stuffed with tasty morsels before burial so they won't be hungry while they're dead.");
                bp.m_Icon = VenkelvoreIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Venkelvore", VenkelvoreFeature, WeaponCategory.Spear, WeaponCategory.Longspear, WeaponCategory.Shortspear);
