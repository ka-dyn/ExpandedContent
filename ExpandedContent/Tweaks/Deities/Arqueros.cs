...
namespace ExpandedContent.Tweaks.Deities {
    internal class Arqueros {
        ...
        public static void AddArquerosFeature() {
            ...
            var ArquerosIcon = AssetLoader.LoadInternal("Deities", "Icon_Arqueros.jpg");
            var ArquerosFeature = Helpers.CreateBlueprint<BlueprintFeature>("ArquerosFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Golden Bulwark, Lord of the Wall   " +
                    ...
                    "with all the power at his disposal, sending legions of his celestial minions to the aid of those who cannot stand for " +
                    "themselves. Only rarely does Arqueros himself appear to protect these chosen devotees; his sacred duty prevents him from " +
                    "leaving the Prime Vallation among the lowest slopes of Heaven except under the direst of circumstances. Bodyguards, guards, " +
                    "and children's guardians-as well as soldiers and civic leaders during a time of war-frequently pay homage to Arqueros." +
                    "\nAppearance: He stands 12 feet tall, and even while completely stationary (as he often is while at rest) he is a spectacle to behold; " +
                    "clad in gleaming golden armor, one gauntleted hand always gripping a diamond-bladed longspear.");
                bp.m_Icon = ArquerosIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Arqueros", ArquerosFeature, WeaponCategory.Spear, WeaponCategory.Longspear, WeaponCategory.Shortspear);
