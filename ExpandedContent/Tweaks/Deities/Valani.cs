...
namespace ExpandedContent.Tweaks.Deities {
    internal class Valani {
        ...
        public static void AddValaniFeature() {
            ...
            var ValaniFeature = Helpers.CreateBlueprint<BlueprintFeature>("ValaniFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Fireshaker, The Father of Islands   " +
                    ...
                    "\nIt is said that trees bend beneath the force of Valani's laugh and his wrathful roar can split the ground around him. Valani's hot temper " +
                    "is well known among the empyreal lords, and his peers respect him for his mastery over the forces of nature. Fireshaker understands that change " +
                    "cannot be forestalled and that growth requires destruction in order for goodness to take root in what was once evil soil. Valani is a massive " +
                    "figure, standing 10 feet tall with the thick arms and legs of a primate and the head of a boar. His wavy dark hair falls free under a crown of " +
