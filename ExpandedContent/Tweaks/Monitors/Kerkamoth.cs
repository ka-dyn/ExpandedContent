...
namespace ExpandedContent.Tweaks.Monitors {
    internal class Kerkamoth {
        ...
        public static void AddKerkamothFeature() {
            ...
            var KerkamothFeature = Helpers.CreateBlueprint<BlueprintFeature>("KerkamothFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Waiting Void   " +
                    ...
                    "\nHoly Symbol: Starry circle within an iron ring   " +
                    "\nAlthough philosophers often confuse decay for the onslaught of entropy, the faithful of Kerkamoth understand that natural decay " +
                    "on both a visible and atomic level is key to a healthy multiverse. That which is empty has its own order and potential to form great " +
                    "things. Just as a toppling tree leaves space for new growth, so too does the deterioration and controlled demolition of civilization " +
                    "leave fallow realms just waiting to be filled by fresh innovation. For creation to continue, there must be regulated emptiness. " +
                    "Above all, these processes must be silently calculated, predictable, and systematic; the wanton destruction inflicted by the likes of " +
                    "daemons, demons, and proteans threatens the entire process.");
                bp.m_Icon = KerkamothIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Kerkamoth", KerkamothFeature, WeaponCategory.Warhammer);
