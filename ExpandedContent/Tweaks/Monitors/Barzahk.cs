...
namespace ExpandedContent.Tweaks.Monitors {
    internal class Barzahk {
        ...
        public static void AddBarzahkFeature() {
            ...
            var BarzahkIcon = AssetLoader.LoadInternal("Deities", "Icon_Barzahk.jpg");
            var BarzahkFeature = Helpers.CreateBlueprint<BlueprintFeature>("BarzahkFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Passage   " +
                    ...
                    "\nHoly Symbol: Two straight lines that converge vertically through a circle   " +
                    "\nWhile most psychopomps are born from the needs and fears of mortals, Barzahk was born from the needs and fears of psychopomps, emerging fully " +
                    "formed at the same moment the Dead Roads—secret back channels between the planes and the mortal world—appeared. Barzahk manifests as an enormous " +
                    "migratory bird, often a corvid, but sometimes as a robin or other songbird. Swathed in robes and carrying a staff and a keyhole, the Passage " +
                    "struggles to understand the finite world beyond the Dead Roads, and they rarely leave this unusual transitive realm. They see to the comings and " +
                    "goings of psychopomps and, by extension, care for the souls of travelers and those who die far from home, an experience that challenges many " +
                    "petitioners and can cause a soul to linger far too long. Afflicted with wanderlust, Barzahk roams aimlessly and rarely attends to any of their " +
                    "appointed duties. Those psychopomps who labor under Barzahk’s purview enjoy an exceptional amount of autonomy, even by the standards of the " +
                    "Boneyard, and many of their most powerful servants begin to feel akin to ushers themselves—notions true ushers are eager to disabuse them of.");
                bp.m_Icon = BarzahkIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Barzahk", BarzahkFeature, WeaponCategory.Club);
