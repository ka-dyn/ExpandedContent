...
namespace ExpandedContent.Tweaks.Monitors {
    internal class Ceyannan {
        ...
        public static void AddCeyannanFeature() {
            ...
            var CeyannanIcon = AssetLoader.LoadInternal("Deities", "Icon_Ceyannan.jpg");
            var CeyannanFeature = Helpers.CreateBlueprint<BlueprintFeature>("CeyannanFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Shepherd   " +
                    ...
                    "\nHoly Symbol: Two concentric circles bisected by a horizontal line   " +
                    "\nCeyannan first arose from the eddies and foam within the River of Souls created by mortals’ resistance to death, and a piece of the Shepherd " +
                    "resides in every mortal heart, allowing this monitor demigod to sense those who flee death’s embrace. Always seeking to recover these lost " +
                    "fragments, Ceyannan gathers wayward souls—the lost, the stolen, and the stubborn—and returns them to the Boneyard. Rumor holds that when the last " +
                    "mortal dies and the Shepherd is whole, Ceyannan will finally embrace death themself. Until that peace comes, Ceyannan relentlessly hunts missing souls, " +
                    "reserving a special hatred for those who would destroy souls or pervert them into undeath. As the patron of lost souls, they are also responsible " +
                    "for containing those souls that pose an existential threat to the cosmos. Ceyannan’s flesh is maggot-white and impossibly beautiful, and their " +
                    "otherwise humanoid frame sports a pair of wings covered in the oily, black feathers of a carrion bird. They often appear clutching the Apostasy, a " +
                    "simple shepherd’s crook capable of dragging out the faith any mortal soul holds for a god. They claim no realm, instead wandering the Material Plane " +
                    "and the River of Souls in search of their lost portions.");
                bp.m_Icon = CeyannanIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Ceyannan", CeyannanFeature, WeaponCategory.Quarterstaff);
