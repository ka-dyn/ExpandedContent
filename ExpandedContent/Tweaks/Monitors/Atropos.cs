...
namespace ExpandedContent.Tweaks.Monitors {
    internal class Atropos {
        ...
        public static void AddAtroposFeature() {
            ...
            var AtroposFeature = Helpers.CreateBlueprint<BlueprintFeature>("AtroposFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Last Sister, Judge of Judges   " +
                    ...
                    "\nHoly Symbol: Six overlapping lines arranged in a hexagon   " +
                    "\nAlso called the Judge of Judges, Atropos rules over the courts of the Boneyard as the penultimate arbitrator of mortal fates. She determines who will " +
                    "die and when, superseded only by Pharasma herself. The youngest daughter of Pharasma, she is also called the Last Sister, though few know the fates or can " +
                    "even confirm the existence of any preceding sisters. Psychopomps whisper that Pharasma is training this child to one day succeed her when the universe dies " +
                    "and is reborn, but for now Atropos holds the domain of sleep rather than true death. She receives the most challenging of all petitioners: the souls of " +
                    "fallen children. Atropos manifests as a large and glorious nosoi the size of a wolf and adorned in a silver mask, with an infinitely long peacock tail " +
                    "decorated with one living eye for every soul she will ever judge, though she sometimes takes on the guise of a young human girl when appearing in her mother’s " +
                    "court. She shares the realm of Pharasma’s Palace, though her deific control also extends over the Boneyard’s courts and planar gates.");
                bp.m_Icon = AtroposIcon;
                bp.Ranks = 1;
