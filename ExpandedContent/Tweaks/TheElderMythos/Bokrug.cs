...
namespace ExpandedContent.Tweaks.TheElderMythos {
    internal class Bokrug {
        ...
        public static void AddBokrugFeature() {
            ...
            var BokrugIcon = AssetLoader.LoadInternal("Deities", "Icon_Bokrug.jpg");
            var BokrugFeature = Helpers.CreateBlueprint<BlueprintFeature>("BokrugFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Water Lizard   " +
                    ...
                    "\nFavoured Weapon: Ranseur (Longspear)   " +
                    "\nHoly Symbol: Green lizard with a long, coiled tail  " +
                    "\nThe original worshipers of Bokrug were a hideous aquatic race who dwelled upon the shores of an ancient lake in a remote corner of the Dreamlands. " +
                    "As humans rose to prominence on the Material Plane, they inevitably came into violent conflict with these creatures. Humans prevailed, but a thousand " +
                    "years later, the spirits of the slain worshipers of Bokrug rose to exact a terrible revenge. Today, in remote regions of the Dimension of Dreams, " +
                    "Bokrug is worshiped out of fear as much as devotion. When those who encounter Bokrug’s cult while traveling this dimension waken, they often carry in " +
                    "their minds the seeds of faith. In this manner, Bokrug’s cult has spread to the waking world. Compared to other deities of the Elder Mythos, Bokrug " +
                    "seems relatively content to bask in the adoration of his worshipers and the powerful storms that often visit the distant dreaming lands he dwells within. " +
                    "The Great Old One does not often seek to destroy others, by design or by accident. Only when his anger and thirst for vengeance are aroused does Bokrug " +
                    "go on the hunt. Bokrug appears as an immense aquatic lizard with spines and sickly green scales. His exceptionally long tail ends in three terrible spines, " +
                    "and his breath is said to be a poisonous green mist. His cult is typically found in rural regions, where worship of the Water Lizard seems to do wonders in " +
                    "the bringing of fine weather and prosperity—as long as blood sacrifices to Bokrug continue. Although he does not demand the sacrifice of sentient creatures, " +
                    "many of his cults have nonetheless taken to sacrificing prisoners or criminals.");
                bp.m_Icon = BokrugIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Bokrug", BokrugFeature, WeaponCategory.Spear, WeaponCategory.Longspear, WeaponCategory.Shortspear);
