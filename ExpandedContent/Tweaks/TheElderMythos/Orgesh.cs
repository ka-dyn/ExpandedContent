...
namespace ExpandedContent.Tweaks.TheElderMythos {
    internal class Orgesh {
        ...
        private static readonly BlueprintFeature IceDomainFeature = Resources.GetBlueprint<BlueprintFeature>("IceDomainFeature");
        private static readonly BlueprintFeature CavesDomainAllowed = Resources.GetBlueprint<BlueprintFeature>("CavesDomainAllowed");
        ...
        public static void AddOrgeshFeature() {
            ...
            var OrgeshIcon = AssetLoader.LoadInternal("Deities", "Icon_Orgesh.jpg");
            var OrgeshFeature = Helpers.CreateBlueprint<BlueprintFeature>("OrgeshFeature", (bp => {

                bp.SetName("Orgesh");
                bp.SetDescription("\nTitles: The Faceless God   " +
                    "\nAlignment: Chaotic Evil   " +
                    "\nAreas of Concern: Alchemy, Caverns, Hunger, Subterranean waterways   " +
                    "\nRank: Great Old One   " +
                    "\nDomains: Chaos, Earth, Evil, Water   " +
                    "\nSubdomains: Caves, Entropy, Fear, Ice, Metal, Oceans   " +
                    "\nFavoured Weapon: Spear   " +
                    "\nHoly Symbol: Open maw surrounding rune   " +
                    "\nIn the Land of Black Blood deep below central Avistan, strange lakes of frozen fluid bubble and roil. Similar in appearance and consistency to crude oil, this black blood " +
                    "is freezing cold to the touch, yet bolsters and invigorates undead flesh. It was within these un-waters that the race known as the charda were spawned, and first among their " +
                    "kind was the Faceless God, Orgesh. Orgesh no longer dwells in the Land of Black Blood, having abandoned its children to that realm. Although they still worship it, generations " +
                    "of neglect have had a positive effect on the charda—they retain their unpredictable ways, yet are no longer driven by cruelty and vengeful hunger. Those who remember but do " +
                    "not venerate Orgesh believe the Faceless God abandoned its children for others found far to the west in the deepest, darkest trenches of the Sightless Sea. Orgesh has no " +
                    "organized cult, and its followers see each other as the greatest threat. Some believe that by consuming the flesh and bones of a fellow devotee of the Faceless God, one can " +
                    "take in that devotee’s faith, and that when but one worshiper remains, Orgesh will return to use this final fanatic to unleash a new race upon the vaults of Orv—a race that " +
                    "may not stop its expansion until all has been consumed. None alive has looked upon Orgesh, yet statues of it remain strangely impervious to erosion, and thus provide evidence " +
                    "of its visage, or lack thereof. These statues depict Orgesh as a vaguely humanoid figure with a hugely distended belly, clawed and doglike legs, and an open mouth filled with " +
                    "shark’s teeth, but with no other facial features whatsoever.");
                bp.m_Icon = OrgeshIcon;
                bp.Ranks = 1;
                ...
                bp.AddComponent<AddFacts>(c => {
                    c.m_Facts = new BlueprintUnitFactReference[1] { IceDomainFeature.ToReference<BlueprintUnitFactReference>() };
                });
