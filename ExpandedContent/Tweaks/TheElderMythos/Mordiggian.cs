...
namespace ExpandedContent.Tweaks.TheElderMythos {
    internal class Mordiggian {
        ...
        public static void AddMordiggianFeature() {
            ...
            var MordiggianIcon = AssetLoader.LoadInternal("Deities", "Icon_Mordiggian.jpg");
            var MordiggianFeature = Helpers.CreateBlueprint<BlueprintFeature>("MordiggianFeature", (bp => {

                bp.SetName("Mordiggian");
                bp.SetDescription("\nTitles: The Charnel God   " +
                    ...
                    "\nHoly Symbol: Bloody fangs surrounded by darkness   " +
                    "\nIn ancient times, Mordiggian was the god of ghouls, yet as these undead spread throughout the countless worlds, many of them lost their way and fell into decadence. " +
                    "These ghouls have forgotten the Charnel God, and only pockets of those from Leng who have not degenerated maintain the ancient rites today. Mordiggian’s primary " +
                    "worshipers in the modern era are humans who venerate him as a death god, yet to the untrained eye, these men and women are little more than ghouls themselves. Using " +
                    "vile rituals and surgical practices, they transform their limbs and visages into ghoulish countenances. In cities where such grotesqueries would cause incident, his " +
                    "worshipers wear heavy cloaks and silver masks to hide their shapes. Mordiggian’s temples are grand mausoleum-cathedrals placed in positions of prominence in their " +
                    "cities. Cities that host such temples have no graveyards of their own, for the priests of Mordiggian collect the bodies of the dead and place them, free of charge, " +
                    "into their sacred vaults for “disposal.” As such, undead and corpse-borne disease are rare contagions in cities under Mordiggian’s care, yet sometimes his priests " +
                    "are too eager in gathering the “dead,” and have been known to take away those in comas or deathlike trances from which they could have recovered. Mordiggian is a " +
                    "living cloud of darkness, capable of congealing and coalescing all or portions of his form within the inky depths to serve his needs, whether he’s manifesting a " +
                    "long, grasping limb to pluck a ripened morsel from a coffin-platter, or visiting his wrath upon those who dare to tread upon halls where only the dead may walk. " +
                    "The Charnel God’s favored form is that of an immense worm with a set of grasping tentacles arrayed around a central maw; this fanged maw appears often in the " +
                    "god’s symbology.");
                bp.m_Icon = MordiggianIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Mordiggian", MordiggianFeature, WeaponCategory.Scimitar);
