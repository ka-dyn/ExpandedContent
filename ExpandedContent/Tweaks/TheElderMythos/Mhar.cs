...
namespace ExpandedContent.Tweaks.TheElderMythos {
    internal class Mhar {
        ...
        public static void AddMharFeature() {
            ...
            var MharIcon = AssetLoader.LoadInternal("Deities", "Icon_Mhar.jpg");
            var MharFeature = Helpers.CreateBlueprint<BlueprintFeature>("MharFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The World Thunder   " +
                    ...
                    "\nHoly Symbol: Shattered triangular rune   " +
                    "\nThe ancient entity known as Mhar first attempted to enter Golarion eons ago, using the planet’s crust as a womb. The attempt to manifest failed for unknown " +
                    "reasons; perhaps the alignment of the planets was not right, or perhaps other entities acted to still the birth before it came to term. Yet Mhar’s cult believes " +
                    "not that their god failed to be born, but rather that its gestation is merely one measured in eons. The cult further believes that the time for Mhar’s birth draws " +
                    "near, and that when the Great Old One—said to dwell deep under the tallest mountain in the Inner Sea region, a peak in the Kodar Mountains known as Mhar Massif—finally wakens, " +
                    "it will transform much of northern Avistan into a new realm of fire and ash that will spread across world. The time of this birth, the cult believes, can be predicted " +
                    "by a sudden increase in the number of violent, fatal earthquakes and sudden instances of volcanism throughout the world, and some of Mhar’s more powerful worshipers " +
                    "seek to hasten that birth by triggering their own tectonic disasters in key places. Mhar’s true shape is unknown, for the deity technically has yet to enter existence. " +
                    "In images created by its cult, the Great Old One is generally depicted as a volcano-shaped leviathan, its caldera surrounded by huge fangs of molten lava and its slopes " +
                    "bearing forests of terrifying, razorsharp crystal limbs.");
                bp.m_Icon = MharIcon;
                bp.Ranks = 1;
                ...
                bp.AddComponent<PrerequisiteAlignment>(c => {
                    c.Alignment = AlignmentMaskType.ChaoticNeutral | AlignmentMaskType.ChaoticGood | AlignmentMaskType.ChaoticEvil | AlignmentMaskType.TrueNeutral;
                });
                ...
                bp.SetAllowedDomains(
                    ...
                    DeityTools.DomainAllowed.AshDomainAllowed,
            ...
            DeityTools.LazySacredWeaponMaker("Mhar", MharFeature, WeaponCategory.HeavyPick);
