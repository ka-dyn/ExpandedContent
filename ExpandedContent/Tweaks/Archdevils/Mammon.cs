...
namespace ExpandedContent.Tweaks.Archdevils {
    internal class Mammon {
        ...
        public static void AddMammon() {
            ...
            var MammonIcon = AssetLoader.LoadInternal("Deities", "Icon_Mammon.jpg");
            var MammonFeature = Helpers.CreateBlueprint<BlueprintFeature>("MammonFeature", (bp => {

                bp.SetName("Mammon");
                bp.SetDescription("\nTitles: The Argent Prince, The Countless, Open Palm, Spirit in Gold, Lord of the Third, The Twice-Fallen   " +
                    "\nRealm: Erebus " +
                    "\nAlignment: Lawful Evil   " +
                    "\nAreas of Concern: Avarice, Watchfulness, Wealth   " +
                    "\nDomains: Artifice, Earth, Evil, Law  " +
                    "\nSubdomains: Construct, Devil, Metal, Toil " +
                    "\nFavoured Weapon: Spear  " +
                    "\nProfane Symbol: Devil-faced coin  " +
                    "\nProfane Animal: Rat  " +
                    "\nIn all greed rings the voice of Mammon. " +
                    "Known throughout the planes as the Countless, the Grasping One, and the Open Palm, none could be better suited to the duty of " +
                    "Hell’s treasurer and vault keeper, as Mammon’s senses extend through every copper of Erebus’s impossibly vast horde. His form having " +
                    "made him something of a mathematical genius, the Grasping One can give an instantly accurate accounting of the wealth he guards, " +
                    "items of particular significance, and the total value of Hell’s riches—an amount measured by a number mortal scholars have yet to " +
                    "discover. Mammon only discloses full reports of his realm’s riches to Asmodeus, but might reveal the location of a particular item " +
                    "to any who offer him a replacement of greater beauty or value. Both the greedy and the poor typically entreat Mammon for aid, calling " +
                    "out to the Open Palm for wealth, station, or other comforts. Typically the archdevil answers the most debased or pathetic requests " +
                    "by assuring that the mortal discovers a coin taken from Erebus. Whispering through such a “lucky copper,” Mammon encourages acts of " +
                    "greater and greater depravity to attain what they desire.");
                bp.m_Icon = MammonIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Mammon", MammonFeature, WeaponCategory.Spear, WeaponCategory.Longspear, WeaponCategory.Shortspear);
