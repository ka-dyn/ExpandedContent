...
namespace ExpandedContent.Tweaks.Archdevils {
    internal class Geryon {
        ...
        public static void AddGeryon() {
            ...
            BlueprintItem ColdIronHeavyFlail = Resources.GetBlueprint<BlueprintItem>("cfc52eb282dfe64459ef3e804bd265ec");

            var GeryonIcon = AssetLoader.LoadInternal("Deities", "Icon_Geryon.jpg");
            var GeryonFeature = Helpers.CreateBlueprint<BlueprintFeature>("GeryonFeature", (bp => {

                bp.SetName("Geryon");
                bp.SetDescription("\nTitles: The Serpent, Source of Lies, Wild Beast, Lord of the Fifth, Betrayer   " +
                    "\nRealm: Stygia " +
                    "\nAlignment: Lawful Evil   " +
                    "\nAreas of Concern: Forbidden Lore, Heresy, Snakes   " +
                    "\nDomains: Evil, Law, Strength, Water  " +
                    "\nSubdomains: Devil, Ferocity, Oceans, Resolve " +
                    "\nFavoured Weapon: Heavy flail  " +
                    "\nProfane Symbol: Serpent's head  " +
                    "\nProfane Animal: Snake  " +
                    "\nAll lies spill from Geryon’s three mouths. As he is among the most physically dominating of the archfiends, those ignorant of the Lord of the Fifth’s " +
                    "cunning might easily mistake him for but some terrible guardian or Hellspawn giant of Stygia’s endless morass. While the impression bears true, such is but " +
                    "a facet of the menace posed by he who is known as the Serpent, the Source of Lies, and the Wild Beast. Geryon’s mere existence profanes the will of the " +
                    "multiverse, and he reigns as lord of all heresies and impossible knowledge. A being of terrifying contradictions, Geryon possesses the cunning and intelligence " +
                    "to craft f lawlessly elaborate lies, along with a body capable of bringing whole nations to ruin.For all of his trickery, though, few things in the multiverse " +
                    "prove more ironclad than the rarely given word of Geryon, for the Source of Lies knows without truth there can be no deception. To this end, the Lord of " +
                    "the Fifth commands legions of osyluths, ordering them to scour Hell and the mortal plane for the greatest secrets they can find. Considering the reports " +
                    "of each, he warps the fulcrum of the most fascinating secrets and, upon the deafening whispers of the Horn of Lies, releases them back to the proper minds, " +
                    "finding that hidden truths serve as soil for the most convincing deceit. Foolishly, those who seek the truth most often call upon Geryon, for the Source of " +
                    "Lies knows his work and can recognize any deception. Although he often provides those who entreat him with insights that bear the taste of truth, rarely " +
                    "are the whispers or visions he bestows anything more than illusions reinforcing blind hopes or suspicions. Those who call upon Geryon risk their souls in " +
                    "order to be lied to, and even his greatest servants rarely know whether they are the Wild Beast’s generals or pawns.");
                bp.m_Icon = GeryonIcon;
                bp.Ranks = 1;
                ...
                bp.SetAllowedDomains(
                    ...
                    DeityTools.DomainAllowed.StrengthDomainAllowed,
                ...
                bp.AddComponent<AddStartingEquipment>(c => {
                    c.m_BasicItems = new BlueprintItemReference[] { 
                        ColdIronHeavyFlail.ToReference<BlueprintItemReference>() 
                    };
            ...
            DeityTools.LazySacredWeaponMaker("Geryon", GeryonFeature, WeaponCategory.HeavyFlail);
