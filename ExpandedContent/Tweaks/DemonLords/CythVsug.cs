...
namespace ExpandedContent.Tweaks.DemonLords {
    internal class CythVsug {
        ...
        public static void AddCythVsugFeature() {
            ...
            var CythVsugFeature = Helpers.CreateBlueprint<BlueprintFeature>("CythVsugFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: Prince of the Blasted Heath, Demon Lord of Fungus and Parasites, Lord of Filth and Pollution" +
                    ...
                    "\nHoly Symbol: Moldy spiraling tentacle" +
                    "\nSacred Animal: Centipede   " +
                    "\nCyth-V’sug’s realm is both a place and a being—an immense parasitic fungus called the Jeharlu capable of extending tendrils into other planes, corrupting " +
                    "them, and then drawing them into the Abyss to expand itself. A quivering, spherical clot of fungal matter much larger than the largest of planets, the Jeharlu " +
                    "lies at the center of an immense cavern, suspended by thick white filaments that attach it to the surrounding rift. Pallid giant worms, moldering shamblers, " +
                    "deformed fungoid dragons, and all manner of demons are but a few of the Jeharlu’s dangers. Cyth-V’sug dwells at the heart of this fungal sphere, an immense " +
                    "monstrosity that appears as a tangled mass of fungal tubers, tentacles, and grasping claws topped by a heaving draconic body with puff ball eyes and jagged " +
                    "teeth. Cyth-V’sug can be thought of as a planetary parasite that infests worlds and consumes them, adding the waste that he leaves behind to his ever-expanding " +
                    "Abyssal realm. One of Cyth-V’sug’s greatest minions, the nascent demon lord Treerazer, recently established a domain on the Material Plane after a failed coup " +
                    "against Cyth-V’sug, yet curiously, the Prince of the Blasted Heath has done little to strike against his wayward minion since.");
                bp.m_Icon = CythVsugIcon;
                bp.Ranks = 1;
