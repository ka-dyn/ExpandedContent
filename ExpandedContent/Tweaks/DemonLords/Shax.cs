...
namespace ExpandedContent.Tweaks.DemonLords {
    internal class Shax {
        ...
        public static void AddShaxFeature() {
            ...
            var ShaxFeature = Helpers.CreateBlueprint<BlueprintFeature>("ShaxFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Blood Marquis, Demon Lord of Lies and Murder" +
                    ...
                    "\nHoly Symbol: White bloody feather" +
                    "\nSacred Animal: Stork   " +
                    "\nCruel and sadistic, Shax revels in the act of torture and murder, especially if the victim retains hope for survival up to the very instant of death. He is " +
                    "particularly fond of eating the eyes of his living victims, but not until he is sure they have seen the filthy tools and bloodstained devices he intends to use " +
                    "upon their bodies. Shax appears as a human man with a dove’s head, bird’s legs, and an immense collection of knives and other bloodstained weaponry. His cultists " +
                    "are typically lone murderers or sadists, often killers who lead double lives as upstanding citizens of society and kill in secret. Shax is the creator of the " +
                    "babau race, and those he creates by skinning living victims and then infusing them with Abyssal energies are the most powerful of their kind. Shax’s realm is " +
                    "the appropriately named Charnelhome, an immense house the size of a city perched atop a slightly slanted bluff surrounded by a vast bog of thorny, blooddrinking " +
                    "plants. Each of Charnelhome’s rooms contains a different insidious deathtrap or horrific guardian—Shax is fond of releasing victims into a wing of the vast manor " +
                    "so he can watch them try to escape, often posing as a fellow prisoner so that the demon lord can experience the victim’s despair and fear on as intimate a level " +
                    "as possible.");
                bp.m_Icon = ShaxIcon;
                bp.Ranks = 1;
