...
namespace ExpandedContent.Tweaks.DemonLords {
    internal class Jubilex {
        ...
        public static void AddJubilexFeature() {
            ...
            var JubilexIcon = AssetLoader.LoadInternal("Deities", "Icon_Jubilex.jpg");
            var JubilexFeature = Helpers.CreateBlueprint<BlueprintFeature>("JubilexFeature", (bp => {

                bp.SetName("Jubilex");
                bp.SetDescription("\nTitles: The Faceless Lord, Lord of Sloth, Demon Lord of Poison and Ooze   " +
                    "\nAlignment: Chaotic Evil   " +
                    "\nAreas of Concern: Poison, Ooze, Sloth  " +
                    "\nDomains: Chaos, Destruction, Evil, Water   " +
                    "\nSubdomains: Catastrophe, Demon, Flotsam, Rage   " +
                    "\nFavoured Weapon: Heavy mace   " +
                    "\nHoly Symbol: Melting red eye   " +
                    "\nSacred Animal: None   " +
                    "\nOf the demon lords listed here, Jubilex is perhaps the one least concerned with maintaining a cult. His favored minions, the omoxes, do more to spread his " +
                    "cults than he does—in fact, it’s debatable whether Jubilex even realizes he has worshipers. Only among the drow is his faith particularly popular and pervasive. " +
                    "Certainly, those who worship him tend not to think of him as an entity to be venerated as much as a source of power. Yet despite the Faceless Lord’s lack of " +
                    "interest in his faithful, he certainly knows of the Material Plane and enjoys absorbing the bodies of unwilling mortals into his protoplasmic bulk. Jubilex " +
                    "appears as a shapeless green mass of ooze shot through with dark ribbons of tar and hundreds of glaring red eyes the size of a man’s head. His realm on the Abyss " +
                    "is called the Undersump, and consists of a tangled warren of sewer-like catacombs and tunnels that winds below dozens of other Abyssal realms—many creatures use " +
                    "the Undersump as a method of covertly moving from one such realm to the other, but they must take care to avoid Jubilex’s awareness when they do. Of course, " +
                    "Jubilex’s wanderings and attention to the regions of the Undersump are basically random, and certain parts of the realm are so rarely visited by the Faceless " +
                    "Lord that other strange and dangerous creatures have claimed them.");
                bp.m_Icon = JubilexIcon;
                bp.Ranks = 1;
            ...
            DeityTools.LazySacredWeaponMaker("Jubilex", JubilexFeature, WeaponCategory.HeavyMace);
