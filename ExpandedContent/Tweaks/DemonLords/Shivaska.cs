...
namespace ExpandedContent.Tweaks.DemonLords {
    internal class Shivaska {
        ...
        public static void AddShivaskaFeature() {
            ...
            var ShivaskaFeature = Helpers.CreateBlueprint<BlueprintFeature>("ShivaskaFeature", (bp => {
                ...
                bp.SetDescription("\nTitles: The Chained Maiden, Lord of Prisons" +
                    ...
                    "\nSubdomains: Demon, Insanity, Loss, Nightmare   " +
                    "\nFavoured Weapon: Heavy flail   " +
                    "\nHoly Symbol: Clock face with 13 hours " +
                    "\nSacred Animal: Tarantula   " +
                    "\nShivaska appears as a female choker with four arms and four legs. Her mouth is unnaturally large, but she has no eyes on her head—her eyes glare " +
                    "red from the palms of her four hands. From her back writhe a dozen long, thin animated chains that end in cruel hooks. Shivaska’s cult has a particular " +
                    "interest in orphanages, and an unsettling number of these institutions have ties to the Chained Maiden. An orphanage under the secret control of the " +
                    "cult of Shivaska uses its orphans for all manner of cruel labor, and keeps the children in line by allowing unsettling aberrations (usually chokers) " +
                    "to prowl the orphanage after dark. Tales of monsters and fears of being taken away by strange things lurking in chimneys or cramped closets or hiding " +
                    "under the floorboards work quite well to keep child laborers in line. Shivaska’s realm on the Abyss is a gloomy temperate wilderness known as the " +
                    "Winding Wood. Her palace, the Ticking House, is an immense workhouse with a huge clock tower, the face of which accounts for 13 hours rather than 12. " +
                    "This clock is kept running by the constant toil of a small army of abducted children.");
                bp.m_Icon = ShivaskaIcon;
                bp.Ranks = 1;
