...
namespace ExpandedContent.Tweaks.Classes.DrakeClass {
    internal class DrakeCompanionWhite {
        ...
        public static void AddDrakeCompanionWhite() {
            ...
            var FormOfTheDragonIIIWhiteBuff = Resources.GetBlueprint<BlueprintBuff>("8dae421e48035a044a4b1a7b9208c5db").GetComponent<Polymorph>();
            ...
            var DrakeCompanionUnitWhite = Helpers.CreateBlueprint<BlueprintUnit>("DrakeCompanionUnitWhite", bp => {
                ...
                bp.Prefab = FormOfTheDragonIIIWhiteBuff.m_Prefab;
            ...
            var DrakeCompanionFeatureWhite = Helpers.CreateBlueprint<BlueprintFeature>("DrakeCompanionFeatureWhite", bp => {
                bp.SetName("Drake Companion - White");
                ...
                bp.m_Icon = BloodlineDraconicWhiteProgression.m_Icon;
                bp.AddComponent<AddPet>(c => {
                    ...
                    c.m_Pet = DrakeCompanionUnitWhite.ToReference<BlueprintUnitReference>();
