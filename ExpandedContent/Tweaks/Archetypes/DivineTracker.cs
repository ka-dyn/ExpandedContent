...
namespace ExpandedContent.Tweaks.Archetypes {
    internal class DivineTracker {
        ...
        public static void AddDivineTracker() {
            ...
            var WarBlessingFeature = Resources.GetBlueprint<BlueprintFeature>("2097edd687ff4cdeb33872c048599fc1");
            ...
            var GloryBlessingFeature = Resources.GetBlueprint<BlueprintFeature>("d082055b649b44c1880442a98f384556");
            var KnowledgeBlessingFeature = Resources.GetBlueprint<BlueprintFeature>("1585a2eec1984d1496ce03021cfa9738");
            var RuneBlessingFeature = Resources.GetBlueprint<BlueprintFeature>("f76713cc1768432cab0d6352f030519d");
            ...
            var TrickeryBlessingMinorAbilityConfig = Resources.GetBlueprint<BlueprintAbility>("c630aa6a5c6566d4995585b94a5d3749").GetComponent<ContextRankConfig>();
            TrickeryBlessingMinorAbilityConfig.m_Class = TrickeryBlessingMinorAbilityConfig.m_Class.AppendToArray(RangerClass.ToReference<BlueprintCharacterClassReference>());
            TrickeryBlessingMinorAbilityConfig.m_AdditionalArchetypes = TrickeryBlessingMinorAbilityConfig.m_AdditionalArchetypes.AppendToArray(DivineTrackerArchetype.ToReference<BlueprintArchetypeReference>());
            ...
            //DLC6
            BlessingTools.CreateDivineTrackerBlessing("DivineTrackerPlantBlessingFeature", PlantBlessingFeature, "At 1st level, as a {g|Encyclopedia:Swift_Action}swift action{/g}, you can cause a creature to sprout entangling vines that attempt to hold it in place, entangling it for 1 {g|Encyclopedia:Combat_Round}round{/g} ({g|Encyclopedia:Saving_Throw}Reflex{/g} negates).\nAt 13th level, you can summon a battle companion. This ability functions as {g|SpellsSummonNaturesAllyIV}summon nature's ally IV{/g}, with a duration of 1 minute. This ability can summon only one animal, regardless of the list used, and the creature's type changes to plant instead of animal. For every 2 levels beyond 10th, the level of the summon nature's ally {g|Encyclopedia:Spell}spell{/g} increases by 1, to a maximum of {g|SpellsSummonNaturesAllyIX}summon nature's ally IX{/g} at 20th level.");
            BlessingTools.CreateDivineTrackerBlessing("DivineTrackerWarBlessingFeature", WarBlessingFeature, "At 1st level, you can touch an ally and grant them a tactical advantage for 1 minute. You can select one of the following {g|Encyclopedia:Bonus}bonuses{/g} to apply to your ally: +10 feet to their base {g|Encyclopedia:Speed}speed{/g}, a +1 dodge bonus to {g|Encyclopedia:Armor_Class}AC{/g}, a +1 insight bonus on {g|Encyclopedia:Attack}attack rolls{/g}, or a +1 luck bonus on {g|Encyclopedia:Saving_Throw}saving throws{/g}. Only one bonus can be applied to a creature at a time.\nAt 13th level, you can touch an ally and grant them a thirst for battle. All of the ally's {g|Encyclopedia:MeleeAttack}melee attacks{/g} are treated as if they had the {g|EnhancementVicious}vicious{/g} weapon special ability, but the additional {g|Encyclopedia:Damage}damage{/g} dealt to the ally from that special ability is nonlethal. In addition, the ally receives a +4 insight bonus on attack rolls made to confirm {g|Encyclopedia:Critical}critical hits{/g}. These benefits last for 1 minute.");
            //I don't know when these were added
            BlessingTools.CreateDivineTrackerBlessing("DivineTrackerCharmBlessingFeature", CharmBlessingFeature, "At 1st level, you can touch an ally and grant an entrancing blessing. For 1 minute, the ally becomes mesmerizing to their opponents, filling them with either abject admiration or paralyzing fear. This effect functions as {g|SpellsArchonsAura}archon's aura{/g}, except if an affected opponent successfully {g|Encyclopedia:Attack}attacks{/g} the ally, the effect ends. This is a mind-affecting effect.\nAt 13th level, you can surround yourself with a tangible aura of majesty for 1 minute. While this aura is active, all enemies within 30 feet must succeed at a {g|Encyclopedia:Saving_Throw}Will saving throw{/g} or fall at your feet in admiration for 1 {g|Encyclopedia:Combat_Round}round{/g}. A successful saving throw grants immunity to this effect.");
            BlessingTools.CreateDivineTrackerBlessing("DivineTrackerGloryBlessingFeature", GloryBlessingFeature, "At 1st level, you can touch an ally and grant them a glorious blessing. For 1 minute, the ally becomes mesmerizing to their foes. This functions as {g|SpellsArchonsAura}archon's aura{/g}, except if an affected opponent successfully {g|Encyclopedia:Attack}attacks{/g} the ally, the effect ends. This is a mind-affecting effect.\nAt 13th level, you can touch an ally and make their killing blows sow terror among enemy ranks. For 1 minute, whenever the ally reduces a target to 0 {g|Encyclopedia:HP}hit points{/g}, they immediately make a {g|Encyclopedia:Persuasion}Persuasion{/g} (intimidate) {g|Encyclopedia:Check}check{/g} to demoralize all foes within 30 feet who can see the kill.");
            BlessingTools.CreateDivineTrackerBlessing("DivineTrackerKnowledgeBlessingFeature", KnowledgeBlessingFeature, "At 1st level, you can temporarily become a master of lore. For 1 minute, you gain the bard's {g|BardLoreMaster}lore master{/g} ability.\nAt 13th level, as a {g|Encyclopedia:Swift_Action}swift action{/g}, you can make a {g|Encyclopedia:TouchAttack}touch attack{/g} against a creature. If the {g|Encyclopedia:Attack}attack{/g} is successful, you learn all of the target's weaknesses, gaining a +2 insight {g|Encyclopedia:Bonus}bonus{/g} on attack and {g|Encyclopedia:Damage}damage rolls{/g}, {g|Encyclopedia:Saving_Throw}saving throws{/g}, and {g|Encyclopedia:Armor_Class}AC{/g} against that creature (the bonus on attack rolls is doubled on {g|Encyclopedia:Dice}rolls{/g} made to confirm {g|Encyclopedia:Critical}critical hits{/g}). This effect lasts for 1 minute.");
            BlessingTools.CreateDivineTrackerBlessing("DivineTrackerRuneBlessingFeature", RuneBlessingFeature, "At 1st level, you can create a blast rune in a desired location. Any creature entering a 5-foot area around the rune takes an amount of {g|Encyclopedia:Damage}damage{/g} equal to {g|Encyclopedia:Dice}1d6{/g} + 1/2 your warpriest level. This rune deals either acid, cold, electricity, or {g|Encyclopedia:Energy_Damage}fire damage{/g}, decided when you create the rune. The rune lasts a number of {g|Encyclopedia:Combat_Round}rounds{/g} equal to your warpriest level.\nAt 13th level, you can touch an ally and inscribe a secret rune on their weapon. For 1 minute, all of their weapon {g|Encyclopedia:Attack}attacks{/g} are treated as adamantine, cold iron, and mithral for all purposes.");
