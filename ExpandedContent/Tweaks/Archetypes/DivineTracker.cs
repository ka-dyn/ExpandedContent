...
namespace ExpandedContent.Tweaks.Archetypes {
    internal class DivineTracker {
        ...
        private static void CreateDivineTrackerBlessing(string blueprintoutputname, BlueprintFeature warpriestblessing, string description) {
