...
namespace ExpandedContent.Utilities {
    internal class SpellWithDesriptorAdders {
        ...
        public static void SkulkingHunterSpellAdder(BlueprintSpellList rangerspelllist, BlueprintSpellList druidspelllist, BlueprintSpellList wizardspelllist, BlueprintSpellList newspelllist) {
            ...
            var NewLevel5Spells = newspelllist.SpellsByLevel[5].m_Spells;
            var NewLevel6Spells = newspelllist.SpellsByLevel[6].m_Spells;
            var RangerLevel1Spells = rangerspelllist.SpellsByLevel[1].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var RangerLevel2Spells = rangerspelllist.SpellsByLevel[2].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var RangerLevel3Spells = rangerspelllist.SpellsByLevel[3].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var RangerLevel4Spells = rangerspelllist.SpellsByLevel[4].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var RangerLevel5Spells = rangerspelllist.SpellsByLevel[5].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var RangerLevel6Spells = rangerspelllist.SpellsByLevel[6].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var DruidLevel1Spells = druidspelllist.SpellsByLevel[1].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var DruidLevel2Spells = druidspelllist.SpellsByLevel[2].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var DruidLevel3Spells = druidspelllist.SpellsByLevel[3].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var DruidLevel4Spells = druidspelllist.SpellsByLevel[4].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var DruidLevel5Spells = druidspelllist.SpellsByLevel[5].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var DruidLevel6Spells = druidspelllist.SpellsByLevel[6].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var WizardLevel1Spells = wizardspelllist.SpellsByLevel[1].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var WizardLevel2Spells = wizardspelllist.SpellsByLevel[2].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var WizardLevel3Spells = wizardspelllist.SpellsByLevel[3].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var WizardLevel4Spells = wizardspelllist.SpellsByLevel[4].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var WizardLevel5Spells = wizardspelllist.SpellsByLevel[5].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
            var WizardLevel6Spells = wizardspelllist.SpellsByLevel[6].Spells.SelectMany(spellandsubspell => spellandsubspell.AbilityAndVariants());
