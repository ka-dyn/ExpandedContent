...
​
​
                static void AddNewDeities()
                {
​
                    var MilaniIcon = AssetLoader.LoadInternal("Deities", "Icon_Milani.jpg");
                    BlueprintFeature AsmodeusSacredWeaponFeature = Resources.GetBlueprint<BlueprintFeature>("2eacfd16f6bc0b445813f28473d3e6ba");
                    var MilaniSacredWeaponFeature = Helpers.CreateBlueprint<BlueprintFeature>("MilaniSacredWeaponFeature", bp =>
                    {
                        ...
                        bp.HideInUI = true;
                        bp.AssetGuid = new BlueprintGuid(new System.Guid("EA519F142085489393E61727B450B8AF"));
                    });
                    Resources.AddBlueprint(MilaniSacredWeaponFeature);
                    ...
                    var MilaniFeature = Helpers.CreateBlueprint<BlueprintFeature>("MilaniFeature", bp =>
                    {
                        ...
                        bp.AssetGuid = new BlueprintGuid(new System.Guid("851E5697-EB254407A32F9A8528429DDD"));
